...
import { CreateCommentAction, DeleteCommentAction } from '../../../redux/actions/ReactionAction'
import { CREATE_COMMENT_RESET, DELETE_COMMENT_RESET } from '../../../redux/constants/ReactionConstant'
                                    ...
                                    <View>
                                        {
                                            post?.user._id === user?._id ? (
                                                <TouchableOpacity style={{ flex: 1, alignItems: "center", justifyContent: "center", paddingRight: 10 }} onPress={() => DeleteCommentFunction(comment?._id)}>
                                                    <IconAntDesign name={'delete'} size={20} color={Colors.dark} />
                                                </TouchableOpacity>
                                            ) : ""
                                        }
